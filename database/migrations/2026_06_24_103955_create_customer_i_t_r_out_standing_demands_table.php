...
return new class extends Migration
{
    ...
    {
        Schema::create('customer_itr_out_standing_demands', function (Blueprint $table) {
            $table->id();
            $table->bigInteger("customer_id");
            $table->unsignedBigInteger('customer_itr_profile_id');
            $table->foreign('customer_itr_profile_id', 'itr_osd')
                ->references('id')
    ...
    {
        Schema::dropIfExists('customer_i_t_r_out_standing_demands');
    }
};
